        ...
        <div class="card">
            ...
            <div id="portifolioBannerTable" class="col-md-6 offset-lg-3 py-5 ">
                @if($message =  session('message'))
                        ...
                        @endif
                        <form id="portifolioBanners" action="{{ route('portifolio_banners.store') }}" method="post" >
                            @csrf
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input name="total_GLA" type="text"  class="form-control @error('total_GLA') is-invalid @enderror"
                                            id="" placeholder="Enter Total GLA*" value="{{ old('total_GLA') }}">
                                    @error('total_GLA')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input name="total_vacancy" type="text"  class="form-control @error('total_vacancy') is-invalid @enderror"
                                            id="" placeholder="Enter Total Vacancy*" value="{{ old('total_vacancy') }}">
                                    @error('total_vacancy')
                                    <div class="invalid-feedback"> {{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input name="total_valuation" type="text"  class="form-control @error('total_valuation') is-invalid @enderror"
                                            id="" placeholder="Enter Total Valuation*" value="{{ old('total_valuation') }}">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('total_weighted') is-invalid @enderror" name="total_weighted" 
                                        ...
                                        id="total_weighted" rows="5">{{ old('total_weighted') }}</textarea>
