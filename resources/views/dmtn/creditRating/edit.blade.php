...
@section('content')
    ...
    <div class="col-xl-12 col-lg-12 mb-4 pl-0">
        <div class="card">
            ...
            @endif
            <form id="creditRating" action="{{ route('credit_ratings.update', $creditRating->id ) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="slug" type="text"  class="form-control @error('slug') is-invalid @enderror"
                                        id="slug" placeholder="Enter Slug*" value="{{ $creditRating->slug }}">
                                @error('slug')
                                <div class="invalid-feedback"> {{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input  name="date_of_document" type="date"  class="form-control @error('date_of_document') is-invalid @enderror"
                                        id="date_of_document" placeholder="Enter PDF Date of creation*" value="{{ $creditRating->date_of_document }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <iframe src="{{ asset('pdf_files/'.$creditRating->pdf) }}"  height="400" width="100%" ></iframe>
                                    <label for="pdf">Upload PDF</label>
                                    <input type="file" value="{{ $creditRating->pdf }}" class="form-control @error('pdf') is-invalid @enderror" name="pdf" id="pdf">
                                    @error('pdf')
                                        <div class="invalid-feedback"> {{ $message }}</div>
                                    @enderror
                                </div>
