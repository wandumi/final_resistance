...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ url('dmtns/policies') }}">Credit Ratings</a></li>
    ...
    <div class="col-xl-12 col-lg-12 mb-4 pl-0">
        <div class="card">
            ...
            <div id="policiesForm" class="col-md-6 offset-lg-3 py-5 ">
                @if($message =  session('message'))
                    <div class="alert alert-success">{{ $message }}</div>
                @endif
                <form  action="{{ url('dmtns/credit_ratings') }}" method="post" enctype="multipart/form-data">
                    @csrf
