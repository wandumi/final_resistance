...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Pricing Supplements</li>
        </ol>
    </div>
    <!-- Invoice Example -->
    <div class="col-xl-12 col-lg-12 mb-4 pl-0">
        <div class="card">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Pricing Supplements</h6>
                <div>
                    <a class="m-0 float-left mr-2 btn btn-info btn-sm" href="{{ url('dmtns/price_supplements_sortable') }}">Sort Pricing Supplements</a>
            ...
            <div class="table-responsive p-3" >
                        ...
                        <table class="table align-items-center table-flush" id="priceSupplementTable">
                            ...
                            @foreach($priceSupplements as $priceSupplement)
                                <tr>
                                    ...
                                    <td>
                                        {{ $priceSupplement->date_of_document }}
                                    </td>
                                    <td>
                                        <iframe src="{{ asset('pdf_files/'.$priceSupplement->pdf) }}"  height="60" width="100vh" ></iframe>
                                    </td>
...
@section('footer')
    ...
    <script>
        $(document).ready(function(){
            $('#priceSupplementTable').DataTable({
                "bFilter" : false,
