...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ url('dmtns/program_documents') }}">Program Document</a></li>
    ...
    <div class="col-xl-12 col-lg-12 mb-4 pl-0">
        <div class="card">
            ...
            <div id="propertiesTable" class="col-md-6 offset-lg-3 py-5 ">
                ...
                @endif
                <form id="progDocument" action="{{ url('dmtns/program_documents') }}" method="post" enctype="multipart/form-data">
                    @csrf
