...
@section('content')
    ...
    <div class="col-xl-12 col-lg-12 mb-4 pl-0">
        <div class="card">
            ...
            <div id="shareholderEdit" class="col-md-6 offset-lg-3 py-5">
                @if($message =  session('message'))
                <div class="alert alert-success">{{ $message }}</div>
            @endif
            <form id="shareholder" action="{{ route('shareholders.update', $shareholder->id ) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input name="name" type="text"  class="form-control @error('name') is-invalid @enderror"
                                    id="name" placeholder="Enter PDF Name*" value="{{ $shareholder->name }}">
                            @error('name')
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input name="numberOfShares" type="text"  class="form-control @error('numberOfShares') is-invalid @enderror"
                                    id="numberOfShares" placeholder="Enter number of shares*" value="{{ $shareholder->numberOfShares }}">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input name="perIssueShared" type="text"  class="form-control @error('perIssueShared') is-invalid @enderror"
                                    id="perIssueShared" placeholder="Enter % issues shared*" value="{{ $shareholder->perIssueShared }}">
                    ...
                    {{-- <div class="col-lg-12">
                        <div class="form-group">
                            <div>
                                <img src="{{ asset('logos/'.$shareholder->logo) }}"  class="img-fluid img-responsive" />
                            </div>
                            <label for="logo">Upload Logo</label>
                            <input type="file" value="{{ $shareholder->logo }}" class="form-control @error('logo') is-invalid @enderror" name="logo" id="logo">
                            @error('logo')
                                <div class="invalid-feedback"> {{ $message }}</div>
                            @enderror
                        </div>
